...
let gamesGetter = async ()=> {
    let req = await fetch("https://amirhosseinshojaii.github.io/battlenet-1-api/db.json")
...
let FeaturedGetter = async ()=> {
    let req = await
    fetch("https://amirhosseinshojaii.github.io/battlenet-2-api/db.json")
    let res = await req.json();
    let data = res.map((elem)=>{
        return `    <div class="flex flex-col gap-2 relative">
        <img class="w-full h-[156px] object-cover" src="${elem.image}" alt="">
...
let TrendGames = async ()=> {
    let req = await
    fetch("https://amirhosseinshojaii.github.io/battlenet-3-api/db.json")
    let res = await req.json();
        let data = res.map((elem)=>{
        return `    <div class="flex flex-col gap-2 relative">
        <img class="w-full h-[156px] object-cover" src="${elem.image}" alt="">
...
let GiftGames = async ()=> {
    let req = await
    fetch("https://amirhosseinshojaii.github.io/battlenet-4-api/db.json")
    let res = await req.json();
        let data = res.map((elem)=>{
        return `    <div class="flex flex-col gap-2 relative">
        <img class="w-full h-[156px] object-cover" src="${elem.image}" alt="">
